...
parser.add_argument('--type', default='resnet18', help='|'.join(selector.known_models))
...
#print(model_raw)
state_dict = model_raw.state_dict()
quant.replace_bn(model_raw)
model_raw.load_state_dict(state_dict,strict=False)
quant.set_bn_param(model_raw)
state_dict = model_raw.state_dict()
for k,v in state_dict.items():
    print("k={0:<35}".format(k))